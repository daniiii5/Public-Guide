...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/sticker-tray-redesign/right.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
May cause crashes; check [this flag](#fix-the-gallery-picker-in-direct-crashing) for details.
...
or (depen![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/mymind-XUlsF9LYeVk-unsplash-10.png)ds on version)
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/oldsettings/mymind-XUlsF9LYeVk-unsplash-9.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/reminder/mymind-XUlsF9LYeVk-unsplash-12.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/translation/translation-1.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/floating/mymind-XUlsF9LYeVk-unsplash.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
```spotify partnership```
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/spotify/mymind-XUlsF9LYeVk-unsplash-15.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
## Enable longer reels
```reels duration```
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/DURATION/mymind-XUlsF9LYeVk-unsplash-7.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/mention-post/mymind-XUlsF9LYeVk-unsplash-6.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/music-search/mymind-XUlsF9LYeVk-unsplash-7.png)
<br>[Jump to start!](#how-to-enabledisable-flags)

## Increase audio preview duration
```audio page music preview duration```
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/long-music-preview/mymind-XUlsF9LYeVk-unsplash-4.png)
<br>[Jump to start!](#how-to-enabledisable-flags)

## Mutual filters
```stories mutuals filter```<br>
Not working at the moment
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/mutuals/mymind-XUlsF9LYeVk-unsplash-8.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/avatar-in-song-pill/mymind-XUlsF9LYeVk-unsplash-2.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/stories-colab-stories/mymind-XUlsF9LYeVk-unsplash-16.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
```share profile to stories```
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/share-profile-to-stories/mymind-XUlsF9LYeVk-unsplash-13.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/fonts/mymind-XUlsF9LYeVk-unsplash-1.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/notes/music.png)
- Location notes

  - ```location notes```
    Keep ```is text required for sharing``` disabled.
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/notes/location.png)
- Videos in notes
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/thread-time-muting/mymind-XUlsF9LYeVk-unsplash-18.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/direct-composer-overflow-is-composer/mymind-XUlsF9LYeVk-unsplash-6.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
...
![alt text](https://github.com/daniiii5/Guide-Preview/blob/main/media/snapshot-messages-per-thread-count/mymind-XUlsF9LYeVk-unsplash-14.png)
<br>[Jump to start!](#how-to-enabledisable-flags)
