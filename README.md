# John's and Dani's Ultimate Guide by Python
...
- [John's and Dani's Ultimate Guide by Python](#johns-and-danis-ultimate-guide-by-python)
...
<video controls src="analytics/final.mp4" title="Title"></video>
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/1440/mymind-XUlsF9LYeVk-unsplash.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/compression/mymind-XUlsF9LYeVk-unsplash-5.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/bitrate/mymind-XUlsF9LYeVk2-unsplash.png)
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/bitrate/mymind-XUlsF9LYeVk-unsplash-3.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
<video controls src="filled/mymind-XUlsF9LYeVk-unsplash2_1.mp4" title="Title"></video>
...
The ```is share tab enabled``` option inside this flag can crash the comments when trying to open them in a post through the See all comments button. Instead, press the comments action to open them.<br>
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/sticker-tray-redesign/right.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
- ```view mode selector enabled``` = true<br>
May cause crashes; check [this flag
](#fix-the-gallery-picker-in-direct-crashing) for details.

Flag information:
- Added in version 327.0.0.0.92
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
or (depen![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/mymind-XUlsF9LYeVk-unsplash-10.png)ds on version)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/oldsettings/mymind-XUlsF9LYeVk-unsplash-9.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
- Added back in version 318.0.0.0.65
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/login/mymind-XUlsF9LYeVk-unsplash-3.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/interop-rebrand/interop-rebrand.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/channels-tab/mymind-XUlsF9LYeVk-unsplash-4.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
- ```should rename advanced settings``` = true

Flag information:
- Added in version 330.0.0.0.4
- Removed in version 343.0.0.0.72
<br>[Jump to start!
](#how-to-enabledisable-flags)

## 🆕Variations of the Reel uploading section
- ```reels publish screen decluttering enable variant a``` = true
- ```reels publish screen decluttering enable variant b``` = true<br>
Only enable one of those two options.

Flag information:
- Added in version 330.0.0.0.4
- Removed in version 345.0.0.0.79
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
- ```clips android profile view count``` - enable everything

Flag information:
- Added in version 332.0.0.0.10
- Removed in version 348.0.0.0.99
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/reminder/mymind-XUlsF9LYeVk-unsplash-12.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
```comments translations```
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/translation/mymind-XUlsF9LYeVk-unsplash-19.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/super-share-v3/mymind-XUlsF9LYeVk-unsplash-17.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
```audience controls```
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/audience-controls/mymind-XUlsF9LYeVk-unsplash-1.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/emhasized/mymind-XUlsF9LYeVk-unsplash-8.png)
Keep disabled:
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/emhasized/2mymind-XUlsF9LYeVk-unsplash.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
- ```feed multiple aspect ratios``` - enable everything

Flag information:
- Added in version 327.0.0.0.70
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
- ```feed text stickers``` - enable everything

Flag information:
- Added in version 316.0.0.0.67
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
<video controls src="remove-follow/disabled_1.mp4" title="Title"></video>
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
Change the value to 3 for 3x speed,
3.5 for 3.5x etc.
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/translation/translation-1.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
Don't enable ```enable swipe debug visualizer``` (it will cause [this:
](#fix-some-green-boxes-showing-while-watching-reels)).<br>
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/floating/mymind-XUlsF9LYeVk-unsplash.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
```spotify partnership```
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/spotify/mymind-XUlsF9LYeVk-unsplash-15.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
```reels duration```
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/DURATION/mymind-XUlsF9LYeVk-unsplash-7.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/mention-post/mymind-XUlsF9LYeVk-unsplash-6.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
# 🆕Comments
## Avatars in comments
- ```avatars in comments``` - enable everything<br>
...
- Added back in version 318.0.0.0.65
## Comment filtering
- ```participation comments dsa``` - enable everything
...
## Comment previews
- ```clips comment previews``` - enable everything
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/music-search/mymind-XUlsF9LYeVk-unsplash-7.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/long-music-preview/mymind-XUlsF9LYeVk-unsplash-4.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/mutuals/mymind-XUlsF9LYeVk-unsplash-8.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/avatar-in-song-pill/mymind-XUlsF9LYeVk-unsplash-2.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/stories-colab-stories/mymind-XUlsF9LYeVk-unsplash-16.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
](#upload-collaborative-stories) or the [multiple close friends lists
](#multiple-close-friends-lists).
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
Not to be confused with the [shared lists
](#🆕shared-lists-in-stories) or the [multiple close friends lists
](#multiple-close-friends-lists).
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
```share profile to stories```
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/share-profile-to-stories/mymind-XUlsF9LYeVk-unsplash-13.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/fonts/mymind-XUlsF9LYeVk-unsplash-1.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
- ```is draft share enabled``` = true

Flag information:
- Added in version 329.0.0.0.70
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/notes/music.png)
- Location notes

  - ```location notes```
    Keep ```is text required for sharing``` disabled.
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/notes/location.png)
- Videos in notes
...
- Enable lives in notes
  ...
  - ```live notes```
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/notes/live.png)
- Enable voice recordings in notes

  - ```audio notes config```
    Keep disabled ```internal only```
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/notes/audios.png)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/notes/translation.png)
- Post note for followers, following or close friends

  - ```notes audience expansion```
- Open profile when pressing it
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/notes/audience.png)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/quiet-mode/mymind-XUlsF9LYeVk-unsplash-11.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
## 🆕Nicknames
- ```igd nicknames``` - enable it<br>
Lets you set nicknames for other people in your chats (they are not showing in the Instagram app for some reason, only in the web version).<br>
The other recipient(s) is/are being informed about the change and the new nickname.

Flag information:
- Added in version 335.0.0.0.78
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/thread-time-muting/mymind-XUlsF9LYeVk-unsplash-18.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/direct-composer-overflow-is-composer/mymind-XUlsF9LYeVk-unsplash-6.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/igd-android-groups-invites/mymind-XUlsF9LYeVk-unsplash-2.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
![alt text
](https: //github.com/daniiii5/Guide-Preview/blob/main/media/snapshot-messages-per-thread-count/mymind-XUlsF9LYeVk-unsplash-14.png)
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
Make sure to have [the highlights design enabled
](#highlights-design).
...
- Added in version 305.0.0.0.107 or earlier
- Removed temporarily in version 318.0.0.0.58
- Added back temporarily in version 318.0.0.0.65
- Removed permanently in version 330.0.0.0.67
<br>[Jump to start!
](#how-to-enabledisable-flags)

## 🆕Add texts and draw in livestreams
- ```live stickers``` - enable everything

Flag information:
- Added in version 330.0.0.0.81
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
- ```is silent toggle enabled``` = false

Flag information:
- Added in version 317.0.0.0.36
- Removed temporarily in version 318.0.0.0.58
- Added back in version 318.0.0.0.65
<br>[Jump to start!
](#how-to-enabledisable-flags)
...
- ```view mode selector enabled``` = false
...
```is reply bar and header enabled```=false
...
- ```profile scroll perf should update``` = false<br>
Got fixed in newer versions even with the flag set to true.

Flag information:
- Added in version 306.0.0.0.75
Removed temporarily in version 310.0.0.0.277
Added back in version 310.0.0.0.285
Removed temporarily again in version 318.0.0.0.58
Added back again in version 318.0.0.0.65
Removed permanently in version 349.0.0.0.27
<br>[Jump to start!
](#how-to-enabledisable-flags)

## 🆕Fix the like button not showing in Stories
- ```stories viewer like mvvvm``` - disable it

Flag information:
- Added in version 335.0.0.0.8
<br>[Jump to start!
](#how-to-enabledisable-flags)

## 🆕Fix the voice message and gallery button missing in some chats in some bases
- ```igd server powered thread capabilities``` - disable everything
...
- ```enable prism headline``` = false

Flag information:
- Added in vesion 311.0.0.0.0
<br>[Jump to start!
](#how-to-enabledisable-flags)