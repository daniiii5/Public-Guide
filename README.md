...
(photos/animations pending)- [Important](#important)
  ...
  - [Remove the reel ads and improve/fix adblocking in instagram mods](#remove-the-reel-ads-and-improve/fix-adblocking-in-instagram-mods)
...
- [Feed](#feed)
  ...
  - [Add notes to posts/reels](#add-notes-to-posts/reels)
  - [Audience controls](#audience-controls)
  - [Auto advance carrousel posts](#auto-advance-carrousel-posts)
  - [Change the intensity of the filter you're adding on a photo in post editor](#change-the-intensity-of-the-filter-you're-adding-on-a-photo-in-post-editor)
...
- [Reels](#reels)
  ...
  - [Floating friend’s likes](#floating-friend’s-likes)
...
- [Direct](#direct)
  ...
  - [New modern design of the "send" button in a chat/note reply/comment composer](#new-modern-design-of-the-"send"-button-in-a-chat/note-reply/comment-composer)
...
- [Profile](#profile)
  ...
  - [Pin your broadcast chat/social channel to your profile](#pin-your-broadcast-chat/social-channel-to-your-profile)
  ...
  - [Zoom people's profile icons](#zoom-people's-profile-icons)
...
- [Fixes](#fixes)
  ...
  - [Fix the text you add in the reels editor being placed 0.5s ahead of where you put it](#fix-the-text-you-add-in-the-reels-editor-being-placed-0.5s-ahead-of-where-you-put-it)
...
view mode selector enabled = true
...
```
bullying comment liked by author
```
...
```
feed  video min length for single loop ms
```
...
```
core flows android increased carousel size limit
```
...
```
long press fast reels fast playback speed
```
...
## Full screen reels
Not working for all versions between 317 and 324.
```
...
ghost writer - enable it

Guide

## Avatars in comments
avatars in comments - enable everything
...
profile scroll perf should update = false
...
Removed in newer versions
```
reels swipe to action enable swipe debug visualizer
```
...
Disable it
```
notes birthday v2 activation enabled
```
